    ...
    <ul>
      <li v-for="(category, index) in categories" :key="index">
        <div class="row">
          ...
          <div class="col-md-2">
            <button class="btn btn-warning mt-3 mb-3" @click="editCategory(index)"><i class="fas fa-edit"></i> Edit Category</button>
          </div>
          <div class="col-md-2">
            <button class="btn btn-danger mt-3 mb-3" @click="deleteCategory(index)"><i class="fas fa-minus-circle"></i> Delete Category</button>
          </div>
        </div>
      </li>
      <li>
        <div class="card mt-3">
          <div class="row">
            ...
            <div class="col-md-4">
              <button class="btn btn-success mt-3 mb-3" @click="addCategory"><i class="fas fa-plus-circle"></i> Add Category</button>
            </div>
          </div>
        </div>
      </li>
...
export default {
  ...
  methods: {
    ...
    deleteCategory (index) {
      if (confirm('Are you sure to delete category ' + this.categories[index].category + '?')) {
